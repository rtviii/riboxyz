...
spheres_expanded_pointset_path = lambda rcsb_id: os.path.join( EXIT_TUNNEL_WORK, rcsb_id.upper(), "{}_spheres_expanded_pointset.npy".format(rcsb_id.upper()), )

translation_vectors_path       = lambda rcsb_id: os.path.join( EXIT_TUNNEL_WORK, rcsb_id.upper(), "{}_normalization_vectors.npy".format(rcsb_id.upper()), )
