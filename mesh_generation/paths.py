...
# from ribctl.lib.schema.types_ribosome import RibosomeOps
...
selected_dbscan_cluster_path   = lambda rcsb_id: os.path.join( Assets(rcsb_id).paths.tunnel_dir, "{}_dbscan_cluster.npy".format(rcsb_id.upper()) )
convex_hull_cluster_path       = lambda rcsb_id: os.path.join( Assets(rcsb_id).paths.tunnel_dir, "{}_convex_hull.npy".format(rcsb_id.upper()) )
