I have an cavity extraction pipeline in my ribosome codebase that i want to clean up a little bit and make more usable/robust. There are a few problems right now:
- the logs are garbage
- remove HOH and nonpolymers in general
- variable atom radiii
- correctness of the first NPET mesh and the smoothness of the second
- Poisson Recon failing on the grid refinement stage..

Basically there are mutliple stages to the pipeline and it works _somewhat_ currently, certainly better than it used to do before, but while trying to optimiz its computational outputs recently (added a refined grid step to try to squeeze out more resolution out of my structure) i started encoutering a new class of failures.

The actual problem i have right now is that i lost track of what algorithm and with which parameters produces the mesh at grid level0 and level1. Supposedly they both should appear in runs/stage70 of the output but the contents are very suspicious espeically in combination with the logs that poisson recon failed. I guess we are using some alternative fallback mehtod in that case...? see i completely lost control of this codebase. If you can help me streamline this a bit, that'd be nice. I would like poisson recon to eventually work on both levels of grid refinemnt and produce smooth usable meshes in both cases and if we need to tweak params a little bit there -- that's ok.

Furhtermore, while refactoring the old implementation (`npet1`) to the new one (`npet2`) it indeed became a bit cleaner, but the the config is still a bit of a mess (even though at least it's all centralized now to a single place). 

The logs are pretty gargbage too -- as in i'd like to see what each phase does, not just whether it completed or failed..

These are my peeves concerning the quality of the code/usability.
...
│   └── runs
│       └── 7K00
│           ├── 20260205_162937_db1c58c692f599cf
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 50_clustering
│           │       └── 55_grid_refine
│           ├── 20260205_163228_27e981d2dbffc2aa
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 55_grid_refine
│           │       └── 60_surface_normals
│           ├── 20260205_163441_3b87ce9b6ac00a88
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260205_164215_3b87ce9b6ac00a88
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 50_clustering
│           │       └── 55_grid_refine
│           ├── 20260205_164438_3b87ce9b6ac00a88
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260205_164733_3b87ce9b6ac00a88
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260205_165623_1465e2230f066ed7
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260205_171457_1465e2230f066ed7
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260206_134627_1465e2230f066ed7
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
...
│           │       ├── 60_surface_normals
│           │       └── 70_mesh_validate
│           ├── 20260206_140350_1465e2230f066ed7
│           │   ├── manifest.json
│           │   └── stage
│           │       ├── 00_inputs
│           │       ├── 10_landmarks
