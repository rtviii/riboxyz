...
My issue right now is though that this second stage appears non-inverted or just complete garbage (it looks like a huge box with cheese holes in it as opposed to the actual tunnel like in the previous stages whereas i expect just a smoother tunnel i guess). Caw we debut this?
...
And here are the main parts of the code (feel free to ask me for more...)
