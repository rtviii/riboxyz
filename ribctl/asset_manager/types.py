...
class AssetType(Enum):
    ...
    NPET_MESH   = AssetInfo("npet_mesh"  , model=None, is_raw=True, dependencies={"STRUCTURE_PROFILE","MMCIF", "ALPHA_SHAPE", "CONSTRICTION_SITE", "PTC"})
    ALPHA_SHAPE = AssetInfo("alpha_shape", model=None,              dependencies={"MMCIF"                                                               })
    SRL         = AssetInfo("sarcin_ricin_loop", model=None, is_raw=True, dependencies={"MMCIF", "STRUCTURE_PROFILE"})
    L7L12STALK  = AssetInfo("l7l12", model=None, is_raw=True, dependencies={"MMCIF", "STRUCTURE_PROFILE"})
    PSTALK      = AssetInfo("l7l12", model=None, is_raw=True, dependencies={"MMCIF", "STRUCTURE_PROFILE"})
