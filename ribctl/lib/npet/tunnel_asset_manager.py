...
class StructureAssets:
    ...
    def ashape_watertight(self):
        return os.path.join(RIBETL_DATA, self.rcsb_id.upper(),"{}_ashape_watertight.ply".format(self.rcsb_id) )

    @property
    def tunnel_mesh(self):
        return os.path.join( RIBETL_DATA, self.rcsb_id.upper(), "{}_tunnel_poisson_recon.ply".format(self.rcsb_id) )
    @property
    def tunnel_mesh_ascii(self):
        return os.path.join( RIBETL_DATA, self.rcsb_id.upper(), "{}_tunnel_poisson_recon_ascii.ply".format(self.rcsb_id) )
