// This file contains all(most) of the pure-cypher invocations used in corresponding bash scripts and
// needed to induce ontology changes in a new riboxyz and commit new structures to it.
...
WITH [1,2,3,4] AS coll UNWIND coll AS x WITH x
