...
from api.ribctl.lib.types.types_polymer import list_LSU_Proteins, list_SSU_Proteins, list_RNAClass
...
def uw__get_all_constraints(tx: Transaction | ManagedTransaction):
    return tx.run("""//
    CALL db.constraints;
    """)